...
public:
     ...
     */
    Container<Item>& getBackpack();
    /*
     *  returns a refernence to trainer's kungroup
     */
    Container<Kun>& getKunGroup();
...
private:
    ...
    Container<Item> backpack;  // the backpack that stores the trainer's items
    Container<Kun> kunGroup;  // the kungroup that stores the trainer's kuns
};
